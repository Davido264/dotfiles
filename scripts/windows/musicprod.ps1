...
WingetInstallPackage -Package ImageLine.FLStudio
...
ScoopInstallPackage -Package "$Global:REPO_DIR/res/extra-packages/windows/youlean-meter.json"
ScoopInstallPackage -Package "$Global:REPO_DIR/res/extra-packages/windows/labs-lm.json"
