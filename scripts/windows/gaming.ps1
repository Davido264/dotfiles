...
WingetInstallPackage -Package EpicGames.EpicGamesLauncher
WingetInstallPackage -Package PrismLauncher.PrismLauncher
...
ScoopInstallPackage -Package "$Global:REPO_DIR/res/extra-packages/windows/ssf2.json"
