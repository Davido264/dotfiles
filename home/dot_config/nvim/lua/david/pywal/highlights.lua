...
M.highlights_base = function(colors)
  local background
  if vim.g.pywal_transparent then
    background = "NONE"
  else
  ...
  return {
    ...
    SignColumn = { bg = background, fg = colors.foreground },
    ...
    PmenuSel = { fg = colors.color0, bg = colors.color4 },
    WildMenu = { fg = colors.color7, bg = colors.color4 },
    CursorLineNr = { fg = colors.color1 },
    Comment = { fg = colors.color1 },
    Folded = { fg = colors.color4, bg = background },
    FoldColumn = { fg = colors.color4, bg = background },
    LineNr = { fg = colors.color9, bg = background },
    FloatBorder = { fg = colors.foreground, bg = background },
    Whitespace = { fg = colors.color1 },
    VertSplit = { fg = colors.color0, bg = colors.color1 },
    ...
    WarningMsg = { fg = colors.color3, bg = background },
    DiffAdd = { fg = colors.color0, bg = colors.color4 },
    DiffChange = { fg = colors.color0, bg = colors.color5 },
    DiffDelete = { fg = colors.color0, bg = colors.color11 },
    QuickFixLine = { bg = colors.color2 },
    PmenuSbar = { bg = background },
    PmenuThumb = { bg = colors.color2 },
    MatchParen = { fg = colors.color4, bg = background },
    ...
    Conceal = { fg = colors.color4, bg = background },
    Directory = { fg = colors.color4 },
    SpecialKey = { fg = colors.color4 },
    Title = { fg = colors.color4 },
    ErrorMsg = { fg = colors.color11, bg = background },
    ...
    Ignore = { fg = colors.color7, bg = background },
    Todo = { fg = colors.color11, bg = background },
    Error = { fg = colors.color11, bg = background },
    ...
    CmpItemAbbrMatch = { fg = colors.color6 },
    CmpItemAbbrMatchFuzzy = { fg = colors.color6 },
    ...
    LspTroubleNormal = { fg = colors.foreground, bg = background },
    ...
    TelescopeSelection = { fg = colors.color0, bg = colors.color1 },

    -- Indent Blank Line
    IndentBlanklineChar = { fg = colors.color1, bg = background },
    ...
    NvimTreeFolderIcon = { fg = colors.color2, bg = background },
    NvimTreeStatusLineNC = { bg = background, fg = colors.color0 },

    -- LspSaga
    LspFloatWinNormal = { bg = colors.background },
    LspFloatWinBorder = { fg = colors.foreground, bg = colors.background },
